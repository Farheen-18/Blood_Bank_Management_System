...
<head>
    ...
    <style>
        ...
        .dropdown-menu , .dropdown-menu a:hover {
            background-color: rgb(104, 173, 247); /* Change the color to match your navbar background */
        }

        .navbar-nav  li a:hover {
            color: rgb(104, 173, 247) !important;
        }
    </style>
</head>
<body style="background-color:rgb(160, 193, 231);">
