...
<head>
    ...
    <style>
        ...
        .dropdown-menu , .dropdown-menu a:hover {
            background-color:rgb(236, 49, 161); /* Change the color to match your navbar background */
        }

        .navbar-nav  li a:hover , .dropdown a:hover {
            color: rgb(236, 49, 161)!important;
        }
    </style>
</head>
<body style="background-color: rgb(241, 158, 208);">
