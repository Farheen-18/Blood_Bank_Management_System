...
<footer class="footer" style="background-color:#1abc9c; color: #FFF; padding: 15px; text-align: center; position: absolute; bottom: 0; width: 100%;">
    &copy; <a style="color:#FFF;" href="https://www.linkedin.com/in/maithili-kolasani-03a9ba315" target="_blank" aria-label="Visit Maithili's LinkedIn profile">Maithili Kolasani </a> 
    and 
    <a style="color:#FFF;" href="https://github.com/Farheen-18/Blood_Bank_Management_System/tree/main" target="_blank" aria-label="Visit Blood Bank Management System repository">Team</a>
</footer>
