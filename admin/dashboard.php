...
<head>
    ...
    <style>
        ...
        .navbar-nav  li a:hover {
            color:  rgb(164, 35, 52) !important;
        }

        .dropdown-menu , .dropdown-menu a:hover {
            background-color:rgb(228, 164, 195); /* Change the color to match your navbar background */
        }
        #animated-image {
        height:25px;
        margin-top: 20px;
...
<body style="background-color:rgb(228, 164, 195);">
    ...
    <?php
        ...
        function print_details(array $row,string $type)
        {
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4"> 
                <div class="card transparent-bg" style="background:rgb(249, 57, 150);border:none;border-radius:16px;">
                    <div class="card-body">
            ';
